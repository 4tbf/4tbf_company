...
export const THOUGHTS: IThoughts[] = [
  ...
  },
  {
    ...
    emojiTop: '613px',
    emojiRight: '112px',
    emojiTopTablet: '447px',
    emojiRightTablet: '-100px',
    emojiTopMobile: '480px',
    emojiRightMobile: '52px',
    commentTop: '431px',
    commentRight: '15px',
    commentTopTablet: '309px',
    commentRightTablet: '-187px',
    commentTopMobile: '360px',
    commentRightMobile: '-30px',
  },
];
