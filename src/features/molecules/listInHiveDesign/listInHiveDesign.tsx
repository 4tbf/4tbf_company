        ...
        <div className="container">
          ...
          <div className={styles.colorsHeader}>
            <Text as="h2" className={styles.title}>
              {t('listInHive.design.colors')}
            </Text>

            <div className={styles.colorWrapper}>
              <div className={`${styles.colorBlock} ${styles.primary}`}>6D6AE0</div>
              <div className={`${styles.colorBlock} ${styles.gray}`}>575574</div>
              <div className={`${styles.colorBlock} ${styles.white}`}>F5F4F9</div>
            </div>
          </div>
          {List_In_Hive_DESIGN.map((current: TINvesTonusDesigne) => {
...
export default ListInHiveDesign;
