...
import { INVES_TONUS_DESIGN } from './constants';
import { TINvesTonusDesigne } from './constantsType';
import styles from './InvesTonusDesign.module.scss';

const InvesTonusDesign = () => {
    ...
    <AnimatePresence>
      <div className={styles.invesTonusDesign}>
        <div className="container">
          ...
          {INVES_TONUS_DESIGN.map((current: TINvesTonusDesigne) => {
            ...
            return (
              ...
              >
                <div className={styles[pagesClass]}>
...
export default InvesTonusDesign;
